...
export class Math2 {
    ...
    static quadraticFormula(a: any, b: any, c: any): number[] | string[];
    ...
    static dintegral: (func?: (x: any, y: any) => any, range?: never[][], stepx?: number, stepy?: number) => number;
    static tintegral: (func?: (x: any, y: any, z: any) => any, range?: never[][], stepx?: number, stepy?: number, stepz?: number) => number;
    ...
    static forBufferedMat(vb?: any[], dims?: number[], asIndex?: (v: any, i: any, x: any, y: any) => any): any[] | undefined;
    static mapBufferedMat(buffer?: any[], dimensions?: number[], asIndex?: (v: any, idx: any, i: any, j: any) => any): any[];
    static combinations(choices?: string[], vecsize?: number): never[][];
    ...
    static matscale(mat: any, scalar: any): never[][];
    static matadd(a: any, b: any): never[][];
    static matsub(a: any, b: any): never[][];
    ...
    static conv2D(mat?: never[][], kern?: never[][], pad?: number): any[];
    ...
    static autocorrelation2d: (mat2d: any) => never[][];
    static autocorrelation2dNormalized(mat2d: any): never[][];
    static crosscorrelation2d(mat2d1: any, mat2d2: any): never[][];
    static crosscorrelation2dNormalized(mat2d1: any, mat2d2: any): never[][];
    static correlograms(dat?: never[][]): any[];
    ...
    static sma(arr: any[] | undefined, window: any): any[];
    ...
    static isExtrema(arr: any, critical?: string): boolean | undefined;
    static isCriticalPoint(arr: any, critical?: string): boolean | undefined;
    ...
    static shift_deflate(mat: any, eigenvalue: any, eigenvector: any): never[][];
